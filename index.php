...
?>
<!-- register  patientMaritialStatus -->
<?php
...
<html lang="en">
    <head>
        ...
        <title>Application de gestion de cabinet medicale</title>
        <!-- Bootstrap -->
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <p class="navbar-text">Avez-vous deja un compte</p>
                        </li>
                        <li class="dropdown">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        <h4>c'est gratuit est pour toujours.</h4>
                                        <div class="row">
                                            <div class="col-xs-6 col-md-6">
                                                <input type="text" name="patientFirstName" class="form-control input-lg" placeholder="First Name" required />
                                            </div>
                                            <div class="col-xs-6 col-md-6">
                                                <input type="text" name="patientLastName" class="form-control input-lg" placeholder="Last Name" required />
                                            </div>
                                        </div>
                                        <input type="text" name="patientMaritialStatus" class="form-control input-lg" placeholder="Your Situation"  required/>
                                        <input type="text" name="patientPhone" class="form-control input-lg" placeholder="Your Phone number"  required/>

                                        <input type="text" name="patientAddress" class="form-control input-lg" placeholder="Your Adresse"  required/>

                                        <input type="text" name="patientEmail" class="form-control input-lg" placeholder="Your Email"  required/>
                                        <input type="number" name="icPatient" class="form-control input-lg" placeholder="Your IC Number"  required/>
                                        ...
                                        <button class="btn btn-lg btn-primary btn-block signup-btn" type="submit" name="signup" id="signup">Crée mon compte</button>
                                    </form>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <p>Ceci est l'horaire du médecin. s'il vous plait <span class="label label-danger">connectez-vous</span> pour prendre un rendez-vous. </p>
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">© MyProject <a href ="https://www.linkedin.com/in/hamza-nissoul/">From Esma School </a></p>
